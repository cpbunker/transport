...
def spinflip(site_i, norbs):
    ...
    Notes 10/16/23
    As best as I can tell this is defined in physicists notation
    (c^\dag_1 c^\dag_2 c_2 c_1) when it should be in chemist's notation
    (c^\dag_1 c_1 c^\dag_2 c_2) and has an overall negative sign
    Also, there was a mistake in 2nd line that I am correcting
    '''
    ...
    sf[site_i[0],site_i[0]+2,site_i[0]+3,site_i[0]+1] += 1;
    ...
    sf[site_i[0]+2,site_i[0],site_i[0]+1,site_i[0]+3] += 1;
