...
params = 1.0, 0.4, -0.005, 0.0, -0.5, 1.0, B, theta
#siam_current.DotDataDmrg(nleads,nelecs_ASU,tf,dt,phys_params = params, bond_dims = [1600,1700,1800,1900,2000], Rlead_pol = Rlead_pol, verbose = verbose);
